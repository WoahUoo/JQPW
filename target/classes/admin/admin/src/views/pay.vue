...
<!--    <div class="pay-type-content">-->
<!--      <div class="pay-type-item">-->
<!--        <el-radio v-model="type" label="扫码支付"></el-radio>-->
<!--&lt;!&ndash;        <img src="qrCodeUrl" alt>&ndash;&gt;-->
...
export default {
  ...
  mounted() {
    ...
    this.table = table;
    this.obj = obj;
    // this.creatQrCode(this.obj.id);
  },
  methods: {
    creatQrCode(id) {
      new QRCode(this.$refs.qrCodeUrl, {
        text: 'http://localhost:8080/jingqupiaowu/shoupiaodingdan/zhifu/'+id, // 转换为二维码的内容
        width: 300,
        height: 300,
        colorDark: '#000000',
        colorLight: '#ffffff',
