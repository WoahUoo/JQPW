<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","display":"flex","width":"100%","justifyContent":"center"}'>
      <el-form :style='{"padding":"40px 20px 20px","boxShadow":"0 1px 20px rgba(64, 158, 255, .5)","margin":"0","borderRadius":"10px","background":"rgba(0,0,0,.75)","width":"500px","height":"auto"}'>
        <div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"20px","color":"#fff","textAlign":"center"}' class="title-container">景区票务销售系统登录</div>
...
.container {
  ...
  position: relative;
      ...
      background: url(img2.jpg) no-repeat center / 100% 100% !important;
