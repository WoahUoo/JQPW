        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="门票类型" prop="menpiaoleixing">
          <el-input v-model="ruleForm.menpiaoleixing"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="购买数量" prop="goumaishuliang">
					<el-input v-model="ruleForm.goumaishuliang" placeholder="购买数量" clearable  :readonly="ro.goumaishuliang"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="总金额" prop="zongjine">
					<el-input v-model="ruleForm.zongjine" placeholder="总金额" clearable  :readonly="ro.zongjine"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="总金额" prop="zongjine">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="取消原因" prop="quxiaoyuanyin">
					<el-input v-model="ruleForm.quxiaoyuanyin" placeholder="取消原因" clearable  :readonly="ro.quxiaoyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="取消原因" prop="quxiaoyuanyin">
