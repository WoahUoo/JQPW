/*
 ...
 Source Schema         : jingqupiaowu

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 11/03/2025 17:22:54
*/
create database jingqupiaowu;
       use jingqupiaowu;
...
-- ----------------------------
-- Table structure for menpiaoleixing
-- ----------------------------
...
CREATE TABLE `menpiaoleixing`  (
  ...
  `menpiaoleixing` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '门票类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门票类型' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of menpiaoleixing
-- ----------------------------
INSERT INTO `menpiaoleixing` VALUES (21, '2025-03-10 20:31:38', '成人票');
INSERT INTO `menpiaoleixing` VALUES (22, '2025-03-10 20:31:38', '儿童票');
INSERT INTO `menpiaoleixing` VALUES (23, '2025-03-10 20:31:38', '团购票');

-- ----------------------------
-- Table structure for menpiaoxinxi
-- ----------------------------
DROP TABLE IF EXISTS `menpiaoxinxi`;
CREATE TABLE `menpiaoxinxi`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `menpiaomingcheng` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '门票名称',
  `fengmian` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '封面',
  `menpiaoleixing` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '门票类型',
  ...
  `youwanxuzhi` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '游玩须知',
  `zhuyishixiang` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '注意事项',
  `menpiaojianjie` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '门票简介',
  `clicktime` datetime(0) NULL DEFAULT NULL COMMENT '最近点击时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门票信息' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of menpiaoxinxi
-- ----------------------------
INSERT INTO `menpiaoxinxi` VALUES (31, '2025-03-10 20:31:38', '门票名称1', 'upload/1741677364188.jpg', '成人票', 1, '开放时间1', '游玩须知1', '注意事项1', '<p>门票简介1</p>', '2025-03-11 15:15:46');
INSERT INTO `menpiaoxinxi` VALUES (32, '2025-03-10 20:31:38', '门票名称2', 'upload/1741677377904.jpg', '儿童票', 2, '开放时间2', '游玩须知2', '注意事项2', '<p>门票简介2</p>', '2025-03-11 15:16:12');
INSERT INTO `menpiaoxinxi` VALUES (33, '2025-03-10 20:31:38', '门票名称3', 'upload/1741677392006.jpg', '团购票', 3, '开放时间3', '游玩须知3', '注意事项3', '<p>门票简介3</p>', '2025-03-11 17:07:57');
...
CREATE TABLE `newstype`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 79 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公告信息分类' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of newstype
-- ----------------------------
INSERT INTO `newstype` VALUES (71, '2025-03-10 20:31:38', '分类名称1');
INSERT INTO `newstype` VALUES (72, '2025-03-10 20:31:38', '分类名称2');
INSERT INTO `newstype` VALUES (73, '2025-03-10 20:31:38', '分类名称3');
INSERT INTO `newstype` VALUES (74, '2025-03-10 20:31:38', '分类名称4');
INSERT INTO `newstype` VALUES (75, '2025-03-10 20:31:38', '分类名称5');
INSERT INTO `newstype` VALUES (76, '2025-03-10 20:31:38', '分类名称6');
INSERT INTO `newstype` VALUES (77, '2025-03-10 20:31:38', '分类名称7');
INSERT INTO `newstype` VALUES (78, '2025-03-10 20:31:38', '分类名称8');

-- ----------------------------
-- Table structure for shoupiaodingdan
-- ----------------------------
DROP TABLE IF EXISTS `shoupiaodingdan`;
CREATE TABLE `shoupiaodingdan`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `dingdanbianhao` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单编号',
  `menpiaomingcheng` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '门票名称',
  `fengmian` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '封面',
  ...
  `goumaishijian` datetime(0) NULL DEFAULT NULL COMMENT '购买时间',
  `shoupiaoyuanzhanghao` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '售票员账号',
  ...
  `menpiaoleixing` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '门票类型',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `dingdanbianhao`(`dingdanbianhao`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 53 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '售票订单' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of shoupiaodingdan
-- ----------------------------
INSERT INTO `shoupiaodingdan` VALUES (51, '2025-03-11 15:25:55', '1741677933707', '门票名称1', 'upload/1741677364188.jpg', 1, 11, 11, '2025-03-11 15:25:33', 'zhangfei', 'zhangfei', '18999999999', '已支付', '成人票');
INSERT INTO `shoupiaodingdan` VALUES (52, '2025-03-11 16:46:21', '1741682779071', '门票名称1', 'upload/1741677364188.jpg', 1, 2, 2, '2025-03-11 16:46:19', 'xiaoming', 'xiaoming', '18955555555', '已支付', '成人票');

-- ----------------------------
-- Table structure for shoupiaoyuan
-- ----------------------------
DROP TABLE IF EXISTS `shoupiaoyuan`;
CREATE TABLE `shoupiaoyuan`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `shoupiaoyuanzhanghao` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '售票员账号',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `shoupiaoyuanzhanghao`(`shoupiaoyuanzhanghao`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1741682720612 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '售票员' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of shoupiaoyuan
-- ----------------------------
INSERT INTO `shoupiaoyuan` VALUES (1730452431448, '2025-03-10 17:13:51', 'zhangfei', 'zhangfei', 'zhangfei', 'upload/1730452418460.jpg', '男', '18999999999', '468555555555555555', 'zhangfei', 'zhangfei');
INSERT INTO `shoupiaoyuan` VALUES (1741682720611, '2025-03-11 16:45:20', 'xiaoming', 'xiaoming', 'xiaoming', 'upload/1741682704146.jpg', '男', '18955555555', '430522222222222222', '18955555555', '18955555555');
...
CREATE TABLE `storeup`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `userid` bigint(20) NOT NULL COMMENT '售票员id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of storeup
-- ----------------------------
INSERT INTO `storeup` VALUES (10, '2025-03-10 17:14:35', 1730452431448, 40, 'menpiaoxinxi', '大摆锤', 'upload/1730452317297.jpg', '1', NULL, NULL);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (1, 1708691678168, '111', 'shoupiaoyuan', '售票员', '0q95776zgwffzwr4dzydrxwltnif6fml', '2025-03-10 20:34:43', '2025-03-10 21:38:37');
INSERT INTO `token` VALUES (2, 1, 'admin', 'users', '管理员', 'lzzn0t8nxgcrk35o6il282cipk1wea6r', '2025-03-10 20:35:22', '2025-03-11 18:09:54');
INSERT INTO `token` VALUES (3, 11, '售票员账号1', 'shoupiaoyuan', '售票员', 'ckr4hc88d1k8q9toplazh9g84ebdm5bh', '2025-03-10 15:54:29', '2025-03-10 16:54:30');
INSERT INTO `token` VALUES (4, 1730452431448, 'zhangfei', 'shoupiaoyuan', '售票员', 'lnxsatl8a1u4q4l4orimkndolsvuzj0u', '2025-03-10 17:14:15', '2025-03-11 17:02:18');
INSERT INTO `token` VALUES (5, 1741682720611, 'xiaoming', 'shoupiaoyuan', '售票员', 'nu5xrxvebcg2kl5x3loakoutgl7i5sbx', '2025-03-11 16:46:11', '2025-03-11 18:06:40');

-- ----------------------------
-- Table structure for tuipiaoxinxi
-- ----------------------------
...
CREATE TABLE `tuipiaoxinxi`  (
  ...
  `menpiaomingcheng` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '门票名称',
  `fengmian` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '封面',
  `piaojia` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '票价',
  `goumaishuliang` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '购买数量',
  `zongjine` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总金额',
  `quxiaoshijian` datetime(0) NULL DEFAULT NULL COMMENT '取消时间',
  `quxiaoyuanyin` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '取消原因',
  `shoupiaoyuanzhanghao` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '售票员账号',
  `xingming` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `shoujihaoma` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号码',
  `crossuserid` bigint(20) NULL DEFAULT NULL COMMENT '跨表售票员id',
  ...
  `menpiaoleixing` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '门票类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退票信息' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of tuipiaoxinxi
-- ----------------------------
INSERT INTO `tuipiaoxinxi` VALUES (60, '2025-03-11 16:02:25', '1741677933707', '门票名称1', 'upload/1741677364188.jpg', '1', '11', '11', '2025-03-11 16:02:22', '1', 'zhangfei', 'zhangfei', '18999999999', 1730452431448, 51, '是', '1', '成人票');
INSERT INTO `tuipiaoxinxi` VALUES (61, '2025-03-11 16:46:40', '1741682779071', '门票名称1', 'upload/1741677364188.jpg', '1', '2', '2', '2025-03-11 16:46:33', '不进去了', 'xiaoming', 'xiaoming', '18955555555', 1741682720611, 52, '是', '1', '成人票');
...
CREATE TABLE `users`  (
  ...
  `addtime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '新增时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '售票员表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'admin', 'admin', 'upload/1708691730974.jpeg', '管理员', '2025-03-10 20:31:38');
